...
async function updateSchema() {
    try {
        ...
        await pool.query(`ALTER TABLE TB_DRIVER_DOCS MODIFY COLUMN DOC_TYPE ENUM('LICENSE', 'QUALIFICATION', 'APTITUDE', 'BIZ_REG', 'TRANSPORT_PERMIT', 'INSURANCE', 'DRIVER_PHOTO', 'VEHICLE_PHOTO', 'TERMS_OF_USE', 'PRIVACY_CONSENT', 'MARKETING_CONSENT', 'DRIVER_CONTRACT', 'TRAVELER_CONTRACT', 'PARTNER_CONTRACT', 'TERMS_INTEGRATED', 'CAREER_CERT', 'BANKBOOK') NOT NULL`);
