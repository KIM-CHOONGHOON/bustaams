 ...
 *
 * 조건: DATA_STAT IN ('AUCTION','BIDDING'), TRAVELER_ID = 로그인 여행자 (`TB_USER.USER_ID` 문자열)
 * UUID_TO_BIN · USER_UUID · TRAVELER_UUID 조회 없음.
 */
    ...
    app.get('/api/traveler/my-quotation-requests', async (req, res) => {
        ...
        try {
            ...
            try {
                ...
                try {
                    [rows] = await connection.execute(SQL_ARCH_MIN, [travelerId]);
