        ...
        <div className="bg-background text-on-surface min-h-[100dvh] pb-40 font-body text-left">
            ...
            <header className="fixed top-0 w-full z-50 bg-white/40 backdrop-blur-3xl border-b border-white/20 py-8">
                <div className="flex justify-between items-center w-full px-6 max-w-7xl mx-auto">
                    ...
                    <div className="w-12 h-12 rounded-xl overflow-hidden border-2 border-white shadow-2xl rotate-3 transition-transform hover:rotate-0">
            ...
            <main className="pt-40 px-6 max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-12 gap-20 animate-in fade-in slide-in-from-bottom duration-1000">
                ...
                <div className="lg:col-span-5 space-y-12 text-left">
                    ...
                    <div className="bg-white p-10 rounded-2xl shadow-2xl shadow-teal-900/5 border border-white relative overflow-hidden group hover:scale-[1.02] transition-all">
                        ...
                        <div className="flex items-center gap-4 text-primary bg-primary/5 p-4 rounded-2xl w-fit">
                ...
                {/* Right: Inquiry Form */}
                <div className="lg:col-span-7 bg-white/40 backdrop-blur-2xl p-12 lg:p-16 rounded-2xl shadow-2xl shadow-teal-900/5 border border-white space-y-12">
                    <form className="space-y-10 text-left">
                            ...
                            <div className="flex flex-wrap gap-3">
                                {categories.map(cat => (
                                    <button 
                                        ...
                                        className={`px-6 py-4 rounded-xl font-black text-[10px] uppercase tracking-widest transition-all active:scale-95 shadow-lg ${selectedCategory === cat ? 'bg-primary text-white shadow-primary/20 p-shadow-xl' : 'bg-slate-50 text-slate-400 hover:bg-slate-100'}`}
                                    >
                                        {cat}
                                    </button>
                                ))}
                        ...
                        <div className="space-y-4">
                            ...
                            <input 
                                className="w-full bg-slate-50 border-4 border-transparent rounded-xl px-8 py-6 text-on-surface font-black text-lg placeholder:text-slate-200 focus:border-primary focus:bg-white transition-all outline-none shadow-inner input-field" 
                        ...
                        <div className="space-y-4">
                            ...
                            <textarea 
                                className="w-full bg-slate-50 border-4 border-transparent rounded-xl px-8 py-8 text-on-surface font-bold text-lg placeholder:text-slate-200 focus:border-primary focus:bg-white transition-all outline-none shadow-inner resize-none h-60 input-field" 
                                placeholder="큐레이터가 명확히 파악할 수 있도록 상세히 적어주세요..." 
                            />
                        </div>

                        {/* Attachments */}
                        <div className="bg-slate-50/50 border-4 border-dashed border-slate-100 rounded-2xl p-12 flex flex-col items-center justify-center gap-6 group cursor-pointer hover:bg-slate-100/50 transition-all">
                            <div className="w-20 h-20 bg-white rounded-xl flex items-center justify-center text-slate-200 group-hover:text-primary group-hover:scale-110 transition-all shadow-xl">
                        ...
                        <div className="pt-8 flex justify-end">
                            <button className="flex items-center gap-6 px-14 py-7 bg-gradient-to-br from-primary to-primary-container text-white rounded-xl font-black text-xs uppercase tracking-[0.4em] shadow-2xl shadow-primary/30 hover:shadow-primary/50 transition-all duration-500 active:scale-95 group btn-primary">
                                Dispatch Message
            ...
            {/* Shared Bottom Nav */}
            <nav className="fixed bottom-10 left-1/2 -translate-x-1/2 z-50 flex justify-around items-center px-4 py-2 bg-slate-900 text-slate-500 w-[90%] max-w-md mx-auto rounded-2xl shadow-[0_40px_80px_-20px_rgba(0,0,0,0.5)] border border-white/10">
