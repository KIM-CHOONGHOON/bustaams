        ...
        <div className="bg-background text-on-surface min-h-[100dvh] pb-40 font-body text-left">
            ...
            <header className="fixed top-0 w-full z-50 bg-white/40 backdrop-blur-3xl border-b border-white/20 py-5">
                <div className="flex justify-between items-center w-full px-6 max-w-7xl mx-auto">
                    ...
                    <div className="w-12 h-12 rounded-xl overflow-hidden border-2 border-white shadow-2xl rotate-3">
            ...
            <main className="pt-32 px-6 max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-12 gap-16">
                ...
                <div className="lg:col-span-5 space-y-12 animate-in fade-in slide-in-from-left duration-700 text-left">
                    <section className="space-y-6 text-left">
                        <div className="inline-block px-5 py-2 rounded-xl bg-secondary/10 text-secondary font-black text-[10px] uppercase tracking-[0.4em] border border-secondary/20">
                            Active Reservation
                        </div>
                        ...
                        <p className="text-slate-400 text-lg max-w-md leading-relaxed font-bold italic">
                            "확정된 버스 대절 예약 내역입니다. 예약 조정은 차량 수급 현황에 따라 제한될 수 있으며, busTaams of 프리미엄 운영 정책이 적용됩니다."
                        </p>
                    </section>

                    {/* Status Card (Asymmetric) */}
                    <div className="relative group text-left">
                        <div className="absolute -inset-6 bg-slate-50/50 rounded-2xl -z-10 transition-all group-hover:scale-105 duration-700"></div>
                        <div className="bg-white rounded-2xl p-10 shadow-2xl shadow-teal-900/5 border-l-8 border-primary text-left">
                            ...
                            <div className="space-y-8 text-left">
                                <div className="flex items-center gap-5 text-left">
                                    <div className="w-14 h-14 rounded-xl bg-primary/5 flex items-center justify-center text-primary shadow-inner">
                                ...
                                <div className="space-y-5 text-left">
                                    ...
                                    {/* Bus Item 1 */}
                                    <div className="flex items-center justify-between p-5 bg-slate-50 rounded-2xl border border-slate-100 group/item hover:bg-white transition-all">
                                        ...
                                        <button className="px-5 py-2 rounded-xl bg-white text-red-500 text-[10px] font-black uppercase tracking-widest border border-red-100 hover:bg-red-500 hover:text-white transition-all">
                                            Cancel Item
                                        </button>
                                    </div>
                                    {/* Bus Item 2 */}
                ...
                <div className="lg:col-span-7 space-y-12 animate-in fade-in slide-in-from-right duration-700 text-left delay-200">
                    {/* Information Panel */}
                    <div className="bg-slate-50 rounded-2xl p-12 space-y-10 border border-slate-100 text-left shadow-inner">
                        <div className="space-y-6 text-left">
                            ...
                            <div className="space-y-4">
                                ...
                                <select 
                                    ...
                                    className="w-full p-6 rounded-xl bg-white border border-slate-200 focus:border-secondary focus:ring-4 focus:ring-secondary/10 outline-none transition-all font-bold text-slate-600 input-field"
                                >
                                    {cancelReasons.map(r => (
                            ...
                            <div className="space-y-4">
                                ...
                                <textarea 
                                    ...
                                    className="w-full p-6 rounded-xl bg-white border border-slate-200 focus:border-secondary focus:ring-4 focus:ring-secondary/10 outline-none transition-all font-bold text-slate-600 h-32 resize-none input-field"
                                />
                            </div>
                            ...
                            <div className="space-y-4">
                                ...
                                <div className="relative group cursor-pointer">
                                    ...
                                    />
                                    <div className="flex items-center gap-5 p-6 bg-white rounded-2xl border-2 border-dashed border-slate-200 group-hover:border-secondary transition-all">
                                        <div className="w-12 h-12 rounded-xl bg-slate-50 flex items-center justify-center text-slate-400 group-hover:bg-secondary/5 group-hover:text-secondary">
                        ...
                        <div className="flex gap-8 items-start text-left pt-6 border-t border-slate-200">
                            <div className="w-16 h-16 shrink-0 rounded-xl bg-secondary flex items-center justify-center shadow-2xl shadow-secondary/30 rotate-3">
                    ...
                    {/* Visual Context */}
                    <div className="relative h-80 rounded-2xl overflow-hidden shadow-2xl shadow-slate-900/10 border-4 border-white text-left group">
