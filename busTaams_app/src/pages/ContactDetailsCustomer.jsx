            ...
            <main className="pt-32 px-6 max-w-3xl mx-auto space-y-12 animate-in fade-in slide-in-from-bottom duration-1000">
                ...
                <div className="flex flex-col md:flex-row md:items-end justify-between gap-6 border-b-4 border-slate-50 pb-10 text-left">
                    <div className="space-y-4 text-left">
                        <span className="inline-flex items-center px-6 py-2 rounded-xl bg-primary text-white text-[10px] font-black tracking-[0.3em] uppercase shadow-xl shadow-primary/20">
                            Protocol Resolved
                        </span>
                ...
                <div className="space-y-10 text-left">
                    {/* User's Message Card */}
                    <section className="bg-white rounded-2xl p-10 md:p-12 shadow-2xl shadow-teal-900/5 border border-white relative overflow-hidden text-left">
                    ...
                    {/* Admin Response Card */}
                    <section className="bg-slate-900 rounded-2xl p-10 md:p-12 relative overflow-hidden shadow-2xl shadow-slate-900/30 text-left animate-in zoom-in duration-700 delay-500">
                        {/* Status Bar */}
                        ...
                        <div className="pl-6 space-y-10 text-left">
                            ...
                            <div className="text-slate-300 font-medium leading-relaxed bg-white/5 p-8 rounded-2xl border border-white/5 text-left text-sm md:text-base">
                                <p>
                            ...
                            <div className="flex justify-end text-left">
                                <button className="bg-primary text-white px-10 py-5 rounded-xl font-black text-[10px] uppercase tracking-[0.3em] shadow-2xl shadow-primary/30 active:scale-95 transition-all hover:bg-white hover:text-black group btn-primary">
