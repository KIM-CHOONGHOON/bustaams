            ...
            <main className="pt-32 pb-32 px-6 max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-12 gap-16 animate-in fade-in slide-in-from-bottom duration-1000">
                ...
                <div className="lg:col-span-8 space-y-20">
                    ...
                    <section className="grid grid-cols-1 md:grid-cols-12 gap-12 items-center text-left">
                        <div className="md:col-span-5 aspect-square rounded-2xl overflow-hidden shadow-2xl shadow-teal-900/10 bg-white border-8 border-white rotate-3 group hover:rotate-0 transition-all duration-700">
                        ...
                        <div className="md:col-span-7 space-y-6 text-left">
                            <div className="flex items-center gap-4 text-left">
                                <span className="bg-primary text-white text-[9px] font-black px-5 py-2 rounded-xl flex items-center gap-2 tracking-widest uppercase shadow-lg shadow-primary/20">
                    ...
                    <section className="space-y-10 text-left">
                        <div className="flex justify-between items-end text-left">
                            ...
                            <div className="flex gap-4">
                                <button className="w-14 h-14 rounded-xl bg-white shadow-xl flex items-center justify-center hover:bg-slate-900 hover:text-white transition-all active:scale-90">
                        ...
                        <div className="grid grid-cols-12 gap-6 h-[500px] text-left">
                            <div className="col-span-8 rounded-2xl overflow-hidden bg-slate-100 relative group">
                                ...
                                <div className="absolute bottom-10 left-10 bg-white/40 backdrop-blur-3xl px-8 py-3 rounded-xl text-black text-[10px] font-black uppercase tracking-widest shadow-2xl">Main Exterior</div>
                            </div>
                            <div className="col-span-4 flex flex-col gap-6">
                                <div className="h-1/2 rounded-2xl overflow-hidden bg-slate-100 relative group">
                                    ...
                                    <div className="absolute top-6 right-6 bg-primary text-white px-4 py-2 rounded-xl text-[8px] font-black uppercase tracking-widest">Lounge</div>
                                </div>
                                <div className="h-1/2 rounded-2xl overflow-hidden bg-slate-900 relative group cursor-pointer">
                    ...
                    <section className="grid grid-cols-2 md:grid-cols-4 gap-6 text-left">
                        {[
                            ...
                            <div key={item.label} className="p-10 rounded-2xl bg-white shadow-2xl shadow-teal-900/5 group hover:bg-slate-900 transition-all duration-500 border border-slate-50 flex flex-col items-center text-center space-y-4">
                    ...
                    <section className="space-y-10 text-left">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 text-left">
                            {[
                                ...
                                <div key={i} className="p-10 bg-white rounded-2xl shadow-2xl shadow-teal-900/5 space-y-6 border border-slate-50 text-left hover:scale-[1.02] transition-all">
                                    <div className="flex justify-between items-center text-left">
                                        <div className="flex items-center gap-4 text-left">
                                            <div className="w-12 h-12 rounded-xl bg-primary/5 flex items-center justify-center text-primary font-black shadow-inner">{review.letter}</div>
                ...
                <div className="lg:col-span-4">
                    <div className="sticky top-32 space-y-8 animate-in fade-in slide-in-from-right duration-1000 delay-300">
                        <div className="bg-slate-900 p-12 rounded-2xl text-left shadow-2xl shadow-slate-900/40 relative overflow-hidden group">
                            ...
                            <button className="w-full mt-12 py-7 rounded-xl bg-primary text-white font-black text-xs uppercase tracking-[0.4em] shadow-2xl shadow-primary/30 active:scale-95 transition-all hover:bg-white hover:text-black group btn-primary">
                                Confirm & Secure Trip
                            </button>
                        ...
                        {/* Status Check */}
                        <div className="p-8 bg-slate-50 rounded-2xl border border-slate-100 flex items-center gap-6">
