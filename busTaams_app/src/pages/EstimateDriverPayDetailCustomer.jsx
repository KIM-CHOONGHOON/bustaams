            ...
            <header className="fixed top-0 w-full z-50 bg-white/80 backdrop-blur-xl shadow-[0_20px_40px_rgba(0,104,95,0.04)] py-4">
                <div className="flex items-center justify-between px-6 max-w-7xl mx-auto w-full">
                    <div className="flex items-center gap-4">
                        ...
                        <h1 className="text-xl font-bold text-teal-900 tracking-tight">기사결제 대기</h1>
                    </div>
                    <div className="flex items-center gap-4">
                        <Avatar
                                                        ...
                                                        <div className="space-y-4 pt-4 border-t border-slate-50">
                                                            <div className="flex flex-col sm:flex-row gap-4">
                                                                <button 
                                                                    ...
                                                                    className="w-full py-4 bg-slate-100 text-slate-600 rounded-xl font-black text-xs uppercase tracking-widest hover:bg-slate-200 transition-all active:scale-95 flex items-center justify-center gap-2 btn-primary"
                                                                >
...
export default EstimateDriverPayDetailCustomer;
