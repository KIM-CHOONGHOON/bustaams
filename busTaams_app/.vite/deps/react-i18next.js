  ...
  childrenArray.forEach((child, childIndex) => {
    ...
    if ((0, import_react.isValidElement)(child)) {
      ...
      if (shouldKeepChild && childPropsCount <= 1) {
        const cnt = isString2(childChildren) ? childChildren : nodesToString(childChildren, i18nOptions, i18n, i18nKey);
...
function Trans({
  ...
  let translation = key ? t3(key, combinedTOpts) : defaultValue;
...
var useTranslation = (ns, props = {}) => {
  ...
  const getSnapshot = (0, import_react7.useCallback)(() => {
    ...
    const calculatedReady = !!(i18n.isInitialized || i18n.initializedStoreOnce) && namespaces.every((n2) => hasLoadedNamespace2(n2, i18n, i18nOptions));
  ...
  const ret = (0, import_react7.useMemo)(() => {
    ...
    arr.ready = ready;
    return arr;
  }, [t3, finalI18n, ready, finalI18n.resolvedLanguage, finalI18n.language, finalI18n.languages]);
