const mysql = require('./busTaams_server/node_modules/mysql2/promise');
const dotenv = require('./busTaams_server/node_modules/dotenv');
...
async function checkData() {
    ...
    try {
        const [rows] = await pool.execute(`
            SELECT BIN_TO_UUID(REQ_UUID) as uuid, TRIP_TITLE, REQ_STAT, BIN_TO_UUID(TRAVELER_UUID) as traveler FROM TB_AUCTION_REQ
        `);
